...
"Step 9: Click on link 'zur n\xe4chsten Seite'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_paging/hyperlink_zur_n_chsten_seite'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/paging/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_paging/hyperlink_zur_n_chsten_seite'))

"Step 10: Click on link 'zur n\xe4chsten Seite'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC22-Verify Paging Functionality on Laminat Page_visual_checkpoint')
